...
> **→ For the parallel execution order, see `docs/BUILD-DEPENDENCY-GRAPH.md`** — a 34-node DAG with the
> critical path computed (**21.31 h**, against ~36 h as configured, and 23.54 h if item 3b is skipped),
