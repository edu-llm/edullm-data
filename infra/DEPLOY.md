...
> (`uv pip install "edullm-data @ git+https://github.com/edu-llm/edullm-data@38bf831a6c3f445e394784018441fd59288b876c"`
> — an exact commit, not a tag; `v0.2.0` omits the `families/` wheel packaging).
